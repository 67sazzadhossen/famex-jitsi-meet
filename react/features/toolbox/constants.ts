...
export const DEFAULT_REDUCED_UI_MAIN_TOOLBAR_BUTTONS = [ 'microphone', 'camera', 'toggle-camera' ];
...
export const THRESHOLDS = [
    ...
    },
    {
        width: 565,
        order: [
            'microphone', 'camera', 'toggle-camera', 'desktop', 'chat', 'raisehand', 'reactions',
            'participants-pane', 'tileview'
        ]
    },
    {
        width: 520,
        order: [ 'microphone', 'camera', 'toggle-camera', 'desktop', 'chat', 'raisehand', 'participants-pane', 'tileview' ]
    },
    {
        width: 470,
        order: [ 'microphone', 'camera', 'toggle-camera', 'desktop', 'chat', 'raisehand', 'participants-pane' ]
    },
    {
        width: 420,
        order: [ 'microphone', 'camera', 'toggle-camera', 'desktop', 'chat', 'participants-pane' ]
    },
    {
        width: 370,
        order: [ 'microphone', 'camera', 'toggle-camera', 'chat', 'participants-pane' ]
    },
    {
        width: 225,
        order: [ 'microphone', 'camera', 'toggle-camera', 'chat' ]
    },
    {
        width: 200,
        order: [ 'microphone', 'camera', 'toggle-camera' ]
    }
];
